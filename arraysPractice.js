...
alert(randomNumber + " " + finder(randomNumber, numbers));
...
alert(removeItem(myGroceryList, 'pizza'));
alert(addItem(myGroceryList, 'milk'));
...
var addTen = function (numArray) {
    var numPlusTenArray = [];
    for(var i = 0; i < numArray.length; i++) {
        numPlusTenArray.push(parseInt(numArray[i]) + 10);
    }
    return numPlusTenArray;
};
